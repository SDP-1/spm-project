	...
	return (
		...
		>
			...
			<motion.button
				...
				whileTap={{ scale: 0.95 }}
				onClick={goToProfile}
				className='w-full py-3 px-4 mb-4 bg-gradient-to-r from-purple-500 to-pink-600 text-white font-bold rounded-lg shadow-lg hover:from-purple-600 hover:to-pink-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-900'
			>
				Go to Profile
			</motion.button>
